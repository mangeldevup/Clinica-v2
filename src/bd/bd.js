export const cardsData = [
  {
    ...
    logo: "http://localhost/hc/assets/images/spt/logospt_negra.png",
    items: [{ label: "Registro de la asistencia en salud", value: "" }],
  },
  {
    title: "IPS: Cajasan",
    headerClass: "bg-light",
    logo: "http://localhost/hc/assets/images/spt/cajasan_nuevo.png",
    items: [
  ...
  },
  {
    ...
    headerClass: "bg-light",
    image: "http://localhost/hc/assets/images/users/5.jpg",
    items: [
...
export const menuItems = [
  ...
  {
    component: "DatosAcompanante",
    text: "Datos del acompañante",
    abbr: "Datos Acompañante",
    icon: "bi bi-person-lines-fill",
    route: "/DatosAcompanante",
  },
  {
    component: "MotivoConsulta",
    text: "Motivo de consulta",
    abbr: "Motivo Consulta",
    icon: "bi bi-clipboard-pulse",
    route: "/MotivoConsulta",
  },
  {
    component: "RevisionSistema",
    text: "Revisión por sistemas",
    abbr: "Revisión Sistema",
    icon: "bi bi-heart-pulse",
    route: "/RevisionSistema",
  },
  {
  ...
  {
    component: "AntecedentesGO",
    text: "Antecedentes Ginecoobstétricos",
    abbr: "Antecedentes GO",
    icon: "bi bi-gender-female",
    route: "/AntecedentesGO",
  },
  {
    component: "AntecedentesAndro",
    text: "Antecedentes Andrológicos",
    abbr: "Antecedentes AND",
    icon: "bi bi-gender-male",
    route: "/AntecedentesAndro",
  },
  {
  ...
  {
    component: "AnalisisConsulta",
    text: "Análisis de la consulta",
    abbr: "Análisis consulta",
    icon: "bi bi-graph-up",
    route: "/AnalisisConsulta",
  },
  {
    component: "Prodecimientos",
    text: "Procedimientos",
    abbr: "Procedimientos",
    icon: "bi bi-scissors",
    route: "/Prodecimientos",
  },
  {
    component: "ExamenLab",
  ...
  {
    component: "IncapacidaMedica",
    text: "Incapacidad Médica",
    abbr: "Incapacidad Médica",
    icon: "bi bi-calendar-x",
    route: "/IncapacidaMedica",
  },
  {
    component: "CierreHC",
    text: "Cierre de historia clínica",
    abbr: "Cierre HC",
