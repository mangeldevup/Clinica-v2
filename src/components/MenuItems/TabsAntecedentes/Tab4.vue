<template>
  ...
  <div
    ...
    id="no-patologicos"
    role="tabpanel"
    aria-labelledby="no-patologicos-tab"
  >
    <div class="row mt-3">
      <div class="col-md-3">
        <div class="mt-3">
    ...
    <ModalCIE10NP @seleccionado="onCIE10Seleccionado" ref="modalCIE10NPRef" />
  </div>
</template>
...
import ModalCIE10NP from "../../ModalCIE10/MCIE10NP.vue";
...
export default {
  ...
  setup(props) {
    ...
    const modalCIE10NPRef = ref(null);
    ...
    const abrirModalCIE10NP = () => {
      if (modalCIE10NPRef.value) {
        modalCIE10NPRef.value.abrirModal();
      } else {
