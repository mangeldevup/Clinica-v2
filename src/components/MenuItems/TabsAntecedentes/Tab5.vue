<template>
  ...
  >
    <div class="row mt-3">
      ...
      <div class="col-md-9">
        <h5 class="text-center mt-4">Registro de Alergias</h5>
        <!-- DataTable -->
    ...
    <ModalCIE10A @seleccionado="onCIE10Seleccionado" ref="modalCIE10ARef" />
  </div>
</template>
...
import ModalCIE10A from "../../ModalCIE10/MCIE10A.vue";
...
export default {
  ...
  setup(props) {
    ...
    const abrirModalCIE10A = () => {
      if (modalCIE10ARef.value) {
        modalCIE10ARef.value.abrirModal();
      } else {
