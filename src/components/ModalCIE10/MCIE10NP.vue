<template>
  <div
    ...
    tabindex="-1"
    :aria-labelledby="`${config.id}LabelP`"
    aria-labelledby="modalCIE10PLabel"
    aria-hidden="true"
  >
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div id="headerm-generalNP" class="modal-header">
          <h1 class="modal-title fs-5 mt-2" :id="`${config.id}LabelP`">
            {{ config.title }}
          </h1>
          <button
            type="button"
        ...
        <div id="contenidom-generalNP" class="modal-body">
          <input
            type="text"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    onMounted(() => {
      modalInstance.value = new Modal(document.getElementById("modalCIE10NP"));
    });
